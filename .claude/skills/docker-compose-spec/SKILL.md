...
description: Reference specification for Docker Compose file format. Use this when creating or modifying docker compose files, defining multi-container applications with services, networks, volumes, configs, and secrets.
---
